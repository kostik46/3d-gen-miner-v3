"""
FastAPI server for TRELLIS-HYBRID-V2.

Pipeline: Image -> Qwen Multi-View (3 views) -> BiRefNet -> TRELLIS Multi-Image -> PLY

Endpoints:
    GET  /health              - Health check
    POST /generate            - Generate from uploaded file (returns binary PLY)
    POST /generate_from_base64 - Generate from base64 JSON (returns JSON with base64 PLY)
    POST /generate-spz        - Generate from uploaded file (returns binary SPZ)
    GET  /setup/info          - Get current configuration
"""
