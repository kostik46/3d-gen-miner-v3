...
class FlowEulerSampler(Sampler):
    ...
    def _inference_model(self, model, x_t, t, cond=None, **kwargs):
        ...
        # Filter out sampler-specific kwargs that model doesn't accept
        model_kwargs = {k: v for k, v in kwargs.items() if k not in ['cfg_strength', 'guidance_strength', 'guidance_rescale', 'neg_cond', 'guidance_interval']}
        return model(x_t, t, cond, **model_kwargs)
